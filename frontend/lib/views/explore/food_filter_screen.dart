  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          '$categoryTitle / ${ctrl.selectedFood.value}',
          style: TextStyle(
            fontSize: 20.sp,
          ...
          children: [
            Row(
              children: [
                ...
                Expanded(
                  child: GestureDetector(
                    onTap: () => Get.off(() => FeederFilterScreen()),
                    child: Container(
                      padding: EdgeInsets.symmetric(
                        horizontal: 12.w,
                        vertical: 8.h,
            ...
            Expanded(
              child: Obx(
                () => GridView.count(
                  ...
                  children: List.generate(ctrl.foodOptions.length, (i) {
                    final option = ctrl.foodOptions[i];
                    final isSel = ctrl.selectedFood.value == option;
                    return GestureDetector(
                      onTap: () {
                        ctrl.setFood(option.name);
                        Get.back();
                      },
                      child: Column(
                        children: [
